...
# print(unexisted_value)

# coords = weather_info.get("coords").get("lat")
# print(coords)
# weather_info["coords"]["lat"]

lattitude = weather_info.get("coords").get("lat")


# ИЗМЕНИТЬ ЗНАЧЕНИЕ.
# print(weather_info.get("username"))
...
testdict = {"value": 60, "value2":67}

weather_info = {"testdict" : None ,
 				"location": "Kyiv",
 				"weather": "mist",
 				"coords": {"lat": 98.06, 
 							"lon": 123.01},
...
# Более подробно о срезых по ссылке - https://pythonworld.ru/osnovy/indeksy-i-srezy.html.html
# print(songs[2:4])
# print(songs[:2])
...
""" ОЧЕНЬ ВАЖНО. Список и словарь это принципльно разные структуры, причины их изобретения - разные. 
Студенты часто попадают в ловушку, когда пробуют использовать словарь как список и наборот.
Пробуют извлекать из списка по ключу или спрашиватю, как по индексу извлечь из словаря. 
А никак, это, в самой основе ,разные вещи.
"""
...
ok_codes = 201,202,203,204


tuple([1,2])
# print(set([1,2,2,2,67]))
